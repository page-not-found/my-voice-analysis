...
def mysptotal(m,p):
    ...
    try:
        ...
        z5=z4.T
        return f'''---------------------------------
| Number  of Syllables  | {z5[0,:][0]}
---------------------------------
| Number of Pauses      | {z5[1,:][0]}
---------------------------------
| Rate of Speech        | {z5[2,:][0]}
---------------------------------
| Articulation Rate     | {z5[3,:][0]}
---------------------------------
| Speaking Duration(Sec)| {z5[4,:][0]}
---------------------------------
| Original Duration(Sec)| {z5[5,:][0]}
---------------------------------
| Balance               | {z5[6,:][0]}
---------------------------------'''
...
| Gender            | Male
---------------------------------
| Mood of speech    | Showing no Emotion, Normal
---------------------------------'''
        elif z4>114 and z4<=135:
            return f'''
| Gender            | Male
---------------------------------
| Mood of speech    | Reading
---------------------------------'''
        elif z4>135 and z4<=163:
            return f'''
| Gender            | Male
